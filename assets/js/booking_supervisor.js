    ...
    window.gcalDisconnect = function(specialistId) {
        ...
        postJSON('admin/gcal_disconnect.php', { specialist_id: specialistId }).then(resp => {
            if (resp.success) {
                ...
                window.location.href = window.location.pathname + '?working_point_user_id=<?= $working_point_user_id ?>&selected_specialist=' + specialistId + '&gcal_disconnected=1';
            } else {
...
// ===== SECOND SECTION - Main Functions =====
        ...
        function changePeriod(period, event) {
            ...
            // Debug output
            console.log('changePeriod called with period:', period);
...
// ===== THIRD SECTION - Additional Functions =====
